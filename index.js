    ...
    req.on('end', () => {
        ...
        if (dataType === 'teamstats'){  
            ...
            for (const stat of stats) { 
                ...
                VALUES (${stat.kickPts}, ${stat.fGAtt}, ${stat.fG50PlusAtt}, ${stat.fGPlusMade}, ${stat.fGLongest}, ${stat.fGMade}, ${stat.fGCompPct}, ${stat.fullName}, ${stat.kickoffAtt}, ${stat.kickoffTBs}, ${stat.rosterId}, ${stat.scheduleId}, ${stat.seasonIndex}, ${stat.statId}, ${stat.stageIndex}, ${stat.teamId}, ${stat.weekIndex}, ${stat.xPAtt}, ${stat.xPMade}, ${stat.xPMade}, ${stat.xPCompPct})
